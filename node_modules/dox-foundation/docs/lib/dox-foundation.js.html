...
.ctx-type { float:right; margin-top:8px }</style></head><body><div class="row"><div class="twelve columns"><h1 class="pagetitle">dox-foundation</h1></div></div><div class="row"><div id="nav" class="three columns"><ul class="side-nav"><li><a href="../../docs/lib/dox-foundation.js.html">lib/dox-foundation.js</a><ul><li><a href="../../docs/lib/dox-foundation.js.html#name">name</a></li><li><a href="../../docs/lib/dox-foundation.js.html#version">version</a></li><li><a href="../../docs/lib/dox-foundation.js.html#templatePath">templatePath</a></li><li><a href="../../docs/lib/dox-foundation.js.html#render">render</a></li><li><a href="../../docs/lib/dox-foundation.js.html#collectFiles">collectFiles</a></li><li><a href="../../docs/lib/dox-foundation.js.html#createTargetFolders">createTargetFolders</a></li><li><a href="../../docs/lib/dox-foundation.js.html#doxFiles">doxFiles</a></li></ul></li></ul></div><div class="nine columns"><div class="comment"><div class="label radius ctx-type">property</div><h1 id="name">name</h1><h5 class="subheader">exports.name</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Parser name</p></div><pre><code class="language-javascript">exports.name = pkg.name;</code></pre></div><div class="comment"><div class="label radius ctx-type">property</div><h1 id="version">version</h1><h5 class="subheader">exports.version</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Parser version</p></div><pre><code class="language-javascript">exports.version = pkg.version;</code></pre></div><div class="comment"><div class="label radius ctx-type">declaration</div><h1 id="templatePath">templatePath</h1><h5 class="subheader">templatePath</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Template used to produce the documentation</p></div><pre><code class="language-javascript">var templatePath = exports.templatePath = '../views/template.jade';</code></pre></div><div class="comment"><div class="label radius ctx-type">method</div><h1 id="render">render</h1><h5 class="subheader">exports.render()</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Parse source code to produce documentation</p></div><pre><code class="language-javascript">exports.render = function(file, files, options){
...
};</code></pre></div><div class="comment"><div class="label radius ctx-type">method</div><h1 id="collectFiles">collectFiles</h1><h5 class="subheader">exports.collectFiles()</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Create an array of all the right files in the source dir</p></div><pre><code class="language-javascript">exports.collectFiles = function(source, options, callback) {
  ...
  return files;
};</code></pre></div><div class="comment"><div class="label radius ctx-type">method</div><h1 id="createTargetFolders">createTargetFolders</h1><h5 class="subheader">exports.createTargetFolders()</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Make sure the folder structure in target mirrors source</p></div><pre><code class="language-javascript">exports.createTargetFolders = function(target, files) {
  var folders = [];
...
};</code></pre></div><div class="comment"><div class="label radius ctx-type">method</div><h1 id="doxFiles">doxFiles</h1><h5 class="subheader">exports.doxFiles()</h5><div class="tags"><ul class="no-bullet"></ul></div><div class="description"><p>Dox all the files found by collectFiles</p></div><pre><code class="language-javascript">exports.doxFiles = function(source, target, options, files) {
  ...
  return files;
};</code></pre></div></div></div><!-- Foundation JS--><script src="http://cdnjs.cloudflare.com/ajax/libs/foundation/3.2.2/javascripts/foundation.min.js"></script><script>/**
